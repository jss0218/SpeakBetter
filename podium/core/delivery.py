...
def analyze_delivery(
    ...
    motion_limit = 0.62 if scenario == "presentation" else 0.52
    gesture_low = 0.04 if scenario == "interview" else 0.08
    gesture_high = 0.82 if scenario == "presentation" else 0.72
